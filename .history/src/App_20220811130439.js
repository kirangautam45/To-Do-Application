        ...
        <div className='Wrapper_Icon_group'>
          ...
          <div class="TodoApp__list">
            <input class="TodoApp__checkbox" type="checkbox">
              <span class="">Go to Hospital</span> <?
              </div><div class="TodoApp__list"><input class="TodoApp__checkbox" type="checkbox" checked=""><span class="TodoApp_completed_task">Go to School</span></div>
          </div>
